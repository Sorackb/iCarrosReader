...
public class ModelCSV {
  ...
  public void saveToFile(List<Brand> brands) throws IOException {
    HashSet<String> attributes = new HashSet<>();
    List<Model> models = new ArrayList<>();
    
    for (Brand brand : brands) {
      models.addAll(brand.getModels());
    }
    ...
    this.saveToFile(attributes, models);
  }
  
  private void saveToFile(HashSet<String> attributes, List<Model> models) throws IOException {
